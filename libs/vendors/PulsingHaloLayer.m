...
- (id)initWithRepeatCount:(float) repeatCount
{
    ...
    if (self) {
        ...
        // default
        self.radius = 60;
        self.fromValueForRadius = 0.26;
        self.toValueForRadius=1.0;
        self.fromValueForAlpha = 0.0;
...
- (void)setupAnimationGroup {
    ...
    scaleAnimation.toValue = @(self.toValueForRadius);
    scaleAnimation.duration = self.animationDuration;
    
    CAKeyframeAnimation *opacityAnimation = [CAKeyframeAnimation animationWithKeyPath:@"opacity"];
    opacityAnimation.duration = self.animationDuration;
    opacityAnimation.values = @[@(self.fromValueForAlpha), @0.50, @0];
